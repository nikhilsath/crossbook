"""Column-level validators for CSV import and data validation.

Each function accepts a list of raw string values and returns a dict with
counts (blank, valid, invalid, warning) and a details breakdown.
"""
